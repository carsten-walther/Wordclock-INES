        ...
        return (
            <>
                <div className="block lg:hidden inset-0">
                    <h1 className="font-bold py-2 lg:pb-6 text-center text-gray-700 dark:text-gray-50 mx-auto mt-6 mb-6">
                        <Logo width={24} height={24} className="text-gray-700 dark:text-gray-50 inline -mt-1 mr-1"/> WordClock
                    </h1>
                    <div className="relative">
                        <button id="menu-toggle" className="flex w-full justify-start px-3 py-3 bg-white dark:bg-gray-800 lg:bg-transparent border rounded border-gray-600 hover:border-gray-700 appearance-none focus:outline-none" onClick={this.toggleMenu.bind(this)}>
                            <span className="text-sm text-gray-700 dark:text-gray-50">Menu</span>
                        </button>
                        <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700 dark:text-gray-50">
                ...
                <div className={`w-full sticky inset-0 ${!this.state.menuOpen ? 'hidden' : ''} lg:h-auto lg:block mt-0 my-2 lg:my-0 border border-gray-400 lg:border-transparent bg-white shadow rounded lg:shadow-none lg:bg-transparent z-20`} id="menu-content">
                    <Logo width={100} height={100} className="text-gray-700 dark:text-gray-50 ml-auto my-7 hidden lg:block"/>
                    <h1 className="text-right text-gray-700 dark:text-gray-50 text-xl font-bold pt-1.5 pb-4 hidden lg:block">
                        WordClock
                    </h1>
                    <hr className="mb-8 hidden lg:block border-gray-200 dark:border-gray-500"/>
