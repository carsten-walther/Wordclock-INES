                    ...
                    <form onSubmit={this.props.onSubmit.bind(this)}>
                        <div className="md:flex mb-6">
                            ...
                            <div className="md:w-2/3">
                                <ColorPicker name="foregroundColor" id="foregroundColor" className="appearance-none block leading-none w-full text-gray-700 border border-gray-300 rounded py-3 px-4" selectedColor={this.props.data.foregroundColor} onChange={this.props.onChange.bind(this)} />
                                <p className="py-2 text-sm text-gray-600">Please select the color for the highlighted words.</p>
                            </div>
                        </div>
                        <div className="md:flex mb-6">
                            <div className="md:w-1/3">
                            ...
                            <div className="md:w-2/3">
                                <ColorPicker name="backgroundColor" id="backgroundColor" className="appearance-none block leading-none w-full text-gray-700 border border-gray-300 rounded py-3 px-4" selectedColor={this.props.data.backgroundColor} onChange={this.props.onChange.bind(this)} />
                                <p className="py-2 text-sm text-gray-600">Please select the color for the background.</p>
                            </div>
                        </div>
                        <div className="md:flex mb-6">
                            <div className="md:w-1/3">
                            ...
                            <div className="md:w-2/3">
                                ...
                                <p className="py-2 text-sm text-gray-600">Please select the brightness for the clock.</p>
                            </div>
                        </div>
                        <div className="md:flex mb-6">
                            <div className="md:w-1/3">
                        ...
                        <div className="md:flex mb-6">
                            ...
                            <div className="md:w-2/3">
                                <div className="relative">
                                    <select name="language" id="language" value={this.props.data.language} className="appearance-none block leading-none w-full text-gray-700 border border-gray-300 rounded py-3 px-4 pr-7" onChange={this.props.onChange.bind(this)}>
                                ...
                                <p className="m-0 py-2 text-sm text-gray-500">Please select your preferred language.</p>
                            </div>
                        </div>
