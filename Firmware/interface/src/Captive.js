...
export default class Captive extends React.Component {
    ...
    render () {
        return (
            <div className="container w-full flex flex-wrap mx-auto px-2 pt-8 lg:pt-16 mt-0 lg:mt-16">
                <div className="w-full lg:w-1/5 px-6 text-xl text-gray-800 leading-normal"></div>
                <section className="w-full lg:w-3/5 mt-1 pb-12">

                    <h2 className="section-header">WiFi Settings</h2>
